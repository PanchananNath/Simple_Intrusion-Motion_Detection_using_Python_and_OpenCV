...
def main():
    ...
    cv2.namedWindow("Hack Movement Detector", flags=cv2.WINDOW_NORMAL)
    ...
    while True:
        ...
        cv2.imshow("Hacks Detection", image_delta)
